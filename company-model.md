...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "AD/01") |
| group        | string   | Parent company group (e.g. "AD/01 Systems") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/ahold-delhaize-technologies-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)