...
const baseCompany = {
  ...
  career: ["https://www.ad01.com"],
  lastScraped: "2026-06-17"
};

const baseJob = {
  url: "https://www.ad01.com/en/vacancy/123_en",
...
describe("generateJobsMarkdown", () => {
  describe("company section", () => {
    it("includes company name as h1", () => {
      ...
      expect(md).toContain("# AHOLD DELHAIZE TECHNOLOGIES SRL");
    });

    it("includes CIF", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("49544242");
    });

    it("includes brand", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("AD/01");
    });
    ...
    it("includes website as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("[https://www.ad01.com](https://www.ad01.com)");
    });
    ...
    it("omits optional fields when not present", () => {
      const minimal = { id: "49544242", company: "AHOLD DELHAIZE TECHNOLOGIES SRL" };
  ...
  describe("jobs section", () => {
    ...
    it("includes job URL as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, [baseJob]);
      expect(md).toContain("[https://www.ad01.com/en/vacancy/123_en]");
    });
    ...
    it("renders multiple jobs", () => {
      const job2 = { ...baseJob, title: "DevOps Engineer", url: "https://www.ad01.com/en/vacancy/456_en" };
    ...
    it("handles job with no optional fields", () => {
      const minimal = { url: "https://www.ad01.com/en/vacancy/999_en", title: "QA Engineer" };
