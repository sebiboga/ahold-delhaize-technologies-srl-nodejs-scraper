...
**job_seeker_ro_spider** — scraper pentru job-urile AD/01 Systems din România.

Extrage anunțurile de pe [AD/01 Careers Romania](https://www.ad01.com/en/jobs/romania) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
1. **Validează compania** — interoghează API-ul public ANAF ([demoanaf.ro](https://demoanaf.ro)) după CIF-ul AD/01 (49544242) și verifică:
   - Denumirea oficială: AHOLD DELHAIZE TECHNOLOGIES SRL
   - Status: activ/inactiv/radiat
   - Adresa completă din registrul comerțului
2. **Cross-validează cu Peviitor** — verifică existența companiei în API-ul Peviitor
3. **Scrape-uiește job-urile** — extrage lista completă de job-uri din API-ul public AD/01 Careers, filtrat pe România
...
6. **Generează docs/jobs.md** — fișier markdown cu informații companie + toate job-urile curente, publicat pe [GitHub Pages](https://sebiboga.github.io/ahold-delhaize-technologies-srl-nodejs-scraper/jobs.md)
...
|---|---|---|
| AD/01 Careers | `https://www.ad01.com/api/jobs/v2/search/...` | Public |
...
AD/01 Careers [robots.txt](https://www.ad01.com/robots.txt) dezactivează:
...
# Doar E2E (API real AD/01 + ANAF + SOLR)
npm run test:e2e
```
